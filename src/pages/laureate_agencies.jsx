    ...
    <div style={{
      ...
      <section style={{
        ...
        <div style={{ maxWidth: "720px", margin: "0 auto" }}>
          ...
          <h1 style={{
            ...
            We work with agents and managers<br />
          ...
          <p style={{
            ...
            Laureate Edition is a curated imprint that develops a small number
            of titles each year with experienced professionals whose ideas have
            shaped their fields. If your client has a body of work that
            deserves permanent form, we should talk.
          </p>
        </div>
      </section>
      ...
      <section style={{
        ...
        <div style={{
          ...
          {[
            {
              title: "Editorial stewardship",
              text: "Our team shapes the structure, voice, and coherence of each manuscript through guided interviews and iterative development. The author directs the ideas. We handle the craft."
            },
            {
              title: "Full production",
              text: "Design, typesetting, and production oversight are managed in-house. Every title is produced to a standard that reflects the seriousness of the work and the reputation of the author."
            },
            {
              title: "Global distribution",
              text: "All titles are produced and distributed for long-term availability in print and digital formats across major retail channels worldwide."
            },
            {
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Projects typically begin with a short introductory call to
            determine fit. If both sides see alignment, we provide a
            detailed project proposal outlining scope, timeline, and
            editorial approach. Development proceeds through guided
            interviews and collaborative sessions, with the author
          ...
          <p style={{
            ...
            For select projects, we also invite a small group of
            accomplished professionals to contribute chapters that
            complement the central work. These contributors are chosen
            for their direct experience with the themes the book explores.
          </p>
          <p style={{
            fontSize: "15px",
            lineHeight: 1.8,
      ...
      <section style={{
        ...
        <p style={{
          ...
          Laureate Edition is designed for professionals whose authority
        ...
        <div style={{
          ...
          <a
            ...
            style={{
              ...
              padding: "12px 32px",
              border: `1px solid ${hoverMaterials ? "#9E7C4B" : "#D0CCC6"}`,
              color: hoverMaterials ? "#9E7C4B" : "#8C8C8C",
              fontSize: "12px",
              letterSpacing: "2px",
              textTransform: "uppercase",
              textDecoration: "none",
      ...
      <section id="contact" style={{
        ...
        <p style={{
          ...
          Representing someone whose work<br />
          has shaped a field?
        </p>
        ...
        <p style={{
          ...
          A short call to explore whether Laureate Edition is the right fit.
        </p>
...
export default LaureateAgencies;
